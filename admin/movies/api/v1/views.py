    ...
    def get_queryset(self):
        queryset = (
            ...
            .annotate(
                ...
                directors=self._aggregate_film_employee(
                    role=PersonFilmWork.Role.DIRECTOR
                ),
                operators=self._aggregate_film_employee(
                    role=PersonFilmWork.Role.OPERATOR
                ),
                screenwriters=self._aggregate_film_employee(
                    role=PersonFilmWork.Role.SCREENWRITER
                ),
            )
            .order_by("tittle")
        )

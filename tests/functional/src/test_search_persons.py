...
@pytest.mark.parametrize(
    ...
    [
        ({"query": "Mat Lucas"}, {"status": 200, "length": 50}),
        ({"query": "Star Wars: Clone Wars"}, {"status": 200, "length": 1}),
        ({"query": "Star Wars"}, {"status": 200, "length": 2}),
        ({"query": "Non-existent"}, {"status": 200, "length": 0}),
    ],
)
@pytest.mark.asyncio
